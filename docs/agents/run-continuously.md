...
- Never stop working. If all issues are completed, do not consider yourself done. 
- The goal is to complete all known objectives, then seek to continuously improve the codebase for effectiveness, security, and maintainability.
- Maintain a todo list as you work, but do not stop at the end of the todo list.
